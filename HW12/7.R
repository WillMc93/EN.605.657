...
mstep <- function(speed, pz, meanz, sdz, meanp, sdp) {
...
print(mstep(speed, 1/2, 1, 1, 3, 1))
print(mstep(speed, 1/5, 2, 2, 3, 1))
print(mstep(speed, 1/5, 2, 2, 2, 1))
print(mstep(speed, 1/5, 2, 1, 2, 1))